...
export const ProductGrid: React.FC<ProductGridProps> = ({
    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-[#FBFBFA] px-20 lg:px-32">
        {/* Compact & Refined Category Navigation Bar - Absolute Spatial Offset */}
        <div className="mt-16 mb-10 flex justify-center w-full">
            <header className="inline-flex items-center bg-white border border-stone-100 rounded-xl p-1 shadow-sm h-12 overflow-hidden">
                ...
                <div className="flex items-center gap-4 text-stone-200 text-[10px] font-medium uppercase tracking-[0.2em] px-8 border-l border-stone-50 h-6">
        ...
        <div className="flex-1 overflow-y-auto pt-6 pb-20 custom-scrollbar pos-scrollbar">
            {loading ? (
